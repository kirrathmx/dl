...
# SET VARIABLES
print "PEQUEnO FORK basado en Stunnel escrito en python crea un tunnel seguro y protege tus datos"
print "------------------------------------------"
print "-Requisitos-"
print "-Inerprete python en Windows,Linux,Android etc."
print "-Diferentes arquitecturas"
print "-Disfruta de tu privacidad"
print "*La verfiicacion de finger print puedes memorizartelo esto te servira para detectar posibles MITM"
print "-------------------------------------------"
print "Creditos ph502 por la idea, Contactos TG: @wt2018, @ph502"
